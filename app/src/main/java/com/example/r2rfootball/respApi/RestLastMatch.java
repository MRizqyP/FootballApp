...
public class RestLastMatch {
    public RestLastMatch(String idEvent, String strHomeTeam, String strAwayTeam, String intHomeScore, String intAwayScore, String dateEvent, String strTime) {
